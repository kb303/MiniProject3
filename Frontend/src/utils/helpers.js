...
export const posterUrl = (id, w = 400, h = 600) =>
  `https://images.unsplash.com/photo-${id}?w=${w}&h=${h}&fit=crop&auto=format`;

export const backdropUrl = (id) =>
  `https://images.unsplash.com/photo-${id}?w=1600&h=700&fit=crop&auto=format`;
...
export const sortMovies = (arr, key) => {
  ...
  if (key === "title-asc")   return copy.sort((a, b) => a.title.localeCompare(b.title));
  return copy;
};
